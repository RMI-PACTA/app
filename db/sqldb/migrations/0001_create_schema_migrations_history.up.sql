/*
 * A special initial migration that creates a trigger to track when a new
 * schema migration is applied, for auditability and debugging.
 *
 * See
 * https://github.com/golang-migrate/migrate/issues/179#issuecomment-479740765
 * for more info.
 */
BEGIN;
...
CREATE FUNCTION track_applied_migration()
RETURNS TRIGGER AS $$
